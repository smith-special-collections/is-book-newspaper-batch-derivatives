...
runbatchprocess.process(FILE_LIST_FILENAME, 'convert -resize 256x256 "$objFileName" "$objDirName/TN.jpg"', concurrentProcesses=MAX_CPUS)
...
# an intermediary
runbatchprocess.process(FILE_LIST_FILENAME, 'convert -compress none "$objFileName" -depth 8 "$objDirName/.8bitOBJ.png"', concurrentProcesses=MAX_CPUS)
...
runbatchprocess.process(FILE_LIST_FILENAME, 'convert -resize 767x767 "$objFileName" "$objDirName/JPG.jpg"', concurrentProcesses=MAX_CPUS)
logging.info('Generating LARGE_JPG.jpg derivatives')
runbatchprocess.process(FILE_LIST_FILENAME, 'convert -resize 1920x1920 "$objFileName" "$objDirName/LARGE_JPG.jpg"', concurrentProcesses=MAX_CPUS)
